#!/usrdump_params_only=None- coding: utf-8 -*-
...
def get_base_parameters():
    ...
    if _BASE_PARAM is None:
        ...
        p.parameter_integrator["dt"]    = 5.0 # ms, 500Hz
...
def tvb_sim_single(
    ...
    # --- baseline 值（用于缩放） ---
    BASE_WEIGHT_NOISE = 3e-05  # 写死 or 从 config 读一次
